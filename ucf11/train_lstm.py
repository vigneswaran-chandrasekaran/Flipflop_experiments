...
class Model(tf.keras.Model):
    ...
    def __init__(self, dim=250):
        ...
        self.convrnn = tf.keras.layers.ConvLSTM2D(64, (3, 3))
...
model = Model()
model.load_weights('lstm_saved/checkpoint')
loss_monitor = []
acc_monitor = []
for e in range(num_epochs):
    ...
    model.save_weights('lstm_saved/checkpoint')
