...
class SynthesisNet(tf.keras.Model):
    ...
    def call(self, x, c_vec, rnn_1_h, rnn_2_h, init_w, init_kappa):
        output_list = []
        w = init_w
        ...
        return (self_end_of_stroke, self_pi, self_mu1, self_mu2,
                ...
                self_rnn_2_h, self_w, self_phi, self_kappa)
...
def sample(length, input_str=None):
    ...
    for i in range(length - 1):
        ...
        (end_of_stroke, pi, mu1, mu2,
         ...
         rnn_2_h, w, phi, kappa) = model(x, c_vec, rnn_1_h, rnn_2_h,
                                                  w, kappa)
...
draw_strokes_random_color(strokes, factor=0.1, svg_filename='sample3.svg')
